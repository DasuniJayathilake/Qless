    ...
    <div className='sidenav'>
        {/* <section class="app"> */}
            <aside className="sidebar">
                ...
                <ul>
                    <li>
                    <a href="#"><i class="ion-bag"></i> <span>Notifications</span></a>
                        {/* <ul class="nav-flyout">
                            <li>
                    ...
                    <li>
                    <a href="#"><i class="ion-ios-paper-outline"></i> <span class="">Dashboard</span></a>
                    {/* <ul class="nav-flyout">
                        <li>
                    ...
                    <li>
                    <a href={'visitors'}><i class="ion-ios-settings"></i> <span class="">Visitors</span></a>
                    {/* <ul class="nav-flyout">
                        <li>
                    ...
                    <li>
                    <a href={'hosts'}><i class="ion-ios-briefcase-outline"></i> <span class="">Hosts</span></a>
                    {/* <ul class="nav-flyout">
                        <li>
                    ...
                    <li>
                    <a href={'appointments'}><i class="ion-ios-analytics-outline"></i> <span class="">Appointments</span></a>
                    {/* <ul class="nav-flyout">
                        <li>
                    ...
                    <li>
                    <a href="#"><i class="ion-ios-medical-outline"></i> <span class="">Messages</span></a>
                    </li>
                    <li>
                    <a href="#"><i class="ion-ios-navigate-outline"></i> <span class="">My Profile</span></a>
                    <ul class="nav-flyout">
                        <li>
                        <a href="#"><i class="ion-ios-flame-outline"></i>View Profile</a>
                        </li>
                        <li>
                        <a href="#"><i class="ion-ios-lightbulb-outline"></i>Edit Profile</a>
                        </li>
                        <li>
                        <a href="#"><i class="ion-ios-location-outline"></i>Settings</a>
                        </li>
                        <li>
                        <a href="#"><i class="ion-ios-locked-outline"></i>Logout</a>
                        </li>
                        <li>
                        {/* <a href="#"><i class="ion-ios-navigate-outline"></i>Ghostface</a> */}
                        </li>
